...
public class PatientHomePage extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_startactivity_patient);

        FirebaseUser firebaseUser = FirebaseAuth.getInstance().getCurrentUser();
        drawerLayout = findViewById(R.id.drawer_layout_Patient);
        Toolbar toolbar = findViewById(R.id.tool_bar_Patient);
        ...
        prof_p = v.findViewById(R.id.profile_icon);
        name_of_patient = v.findViewById(R.id.userid);
        ...
        databaseReference.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                name_of_patient.setText(dataSnapshot.getValue(String.class));
            }
        ...
        //
        recyclerView = findViewById(R.id.posts_p);
    ...
    private void fetch() {
        ...
        adapter = new FirebaseRecyclerAdapter<post_grivience, PatientHomePage.ViewHolder>(options) {
            @Override
            protected void onBindViewHolder(@NonNull final PatientHomePage.ViewHolder viewHolder, int position, @NonNull final post_grivience post_grivience) {
            ...
            @Override
            public PatientHomePage.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
                View view = LayoutInflater.from(parent.getContext())
                        .inflate(R.layout.cardview, parent, false);

                return new PatientHomePage.ViewHolder(view);
            }
    ...
    public boolean onNavigationItemSelected(@NonNull MenuItem menuItem) {
        switch (menuItem.getItemId()) {
            ...
            case R.id.pat_profile:
                ...
                startActivity(new Intent(PatientHomePage.this, Patient_profile_view.class));
                finishAfterTransition();

                break;
            case R.id.document_store:
                startActivity(new Intent(PatientHomePage.this, document_view_for_p.class));
                finishAfterTransition();
                break;
            case R.id.pat_draft:
                startActivity(new Intent(PatientHomePage.this, ViewDraft.class));
                finishAfterTransition();

                break;
            case R.id.Secretcode:
                startActivity(new Intent(PatientHomePage.this, Secretcodegenerator.class));
                finishAfterTransition();
                break;
            case R.id.p_logout:
