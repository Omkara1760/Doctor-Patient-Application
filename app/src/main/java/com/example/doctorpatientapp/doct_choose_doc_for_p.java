...
public class doct_choose_doc_for_p extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_doct_choose_doc_for_p);
    ...
    public void onBackPressed() {
        super.onBackPressed();
        startActivity(new Intent(this, patient_login_for_doctor.class));
        finishAfterTransition();
    }

    public void upload() {
        storageReference = FirebaseStorage.getInstance().getReference().child("+91"+patient_login_for_doctor.mobileno_of_user).child("MyDocuments");
        ...
        if (imageuri != null) {
            ...
            fileref.putFile(imageuri).addOnSuccessListener(new OnSuccessListener<UploadTask.TaskSnapshot>() {
                ...
                public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                    firebaseUser = FirebaseAuth.getInstance().getCurrentUser();
                    EditText discription = findViewById(R.id.description);
                    databaseReference = FirebaseDatabase.getInstance().getReference().child("+91"+patient_login_for_doctor.mobileno_of_user).child("MyDocuments");
                    ...
                    Toast.makeText(doct_choose_doc_for_p.this, "Uploaded successfully", Toast.LENGTH_SHORT).show();
